...
class RAGSystem:
    ...
    def __init__(self, config):
        ...
        self.ai_generator = AIGenerator(config.AWS_ACCESS_KEY_ID, config.AWS_SECRET_ACCESS_KEY, config.AWS_SESSION_TOKEN, config.AWS_REGION, config.AWS_BEDROCK_MODEL)
